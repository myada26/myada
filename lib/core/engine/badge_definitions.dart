...
class BadgeRegistry {
  ...
  static const List<BadgeDef> all = [
    ...
    // ── Category 6: Rare Mastery Badges ───────────────────────────────────────
    BadgeDef(
      id: 'clean_sweep',
      name: 'Clean Sweep',
      description: 'Complete an entire module with zero hints used throughout.',
    ...
    BadgeDef(
      id: 'comeback_kid',
      name: 'Comeback Kid',
      description: 'Fail a quiz, then retake it and score 90% or higher.',
    ...
    BadgeDef(
      id: 'night_owl',
      name: 'Night Owl',
      description: 'Complete 5 lessons between 10 PM and 5 AM.',
      icon: Icons.nightlight_round,
      category: BadgeCategory.streak,
      trigger: BadgeTrigger.count,
      targetCount: 5,
      isRare: true,
      relevantEvents: ['lesson_completed'],
    ),
    BadgeDef(
      id: 'early_bird',
      name: 'Early Bird',
      description: 'Complete 5 lessons before 7 AM.',
    ...
    BadgeDef(
      id: 'speed_demon',
      name: 'Speed Demon',
      description: 'Finish a timed challenge with more than 50% of the time remaining.',
      icon: Icons.flash_on_rounded,
      category: BadgeCategory.coding,
      trigger: BadgeTrigger.quality,
      isRare: true,
      relevantEvents: ['timed_challenge_completed'],
    ),
    BadgeDef(
      id: 'silent_solver',
      name: 'Silent Solver',
      description: 'Complete 10 exercises with zero hints ever used.',
    ...
    BadgeDef(
      id: 'perfectionist',
      name: 'Perfectionist',
      description: 'Score 100% on 3 different module quizzes.',
